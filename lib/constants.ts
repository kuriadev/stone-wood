...
export const INIT_BOOKINGS: Booking[] = [
  ...
  { id: "SW-10002", name: "Jose Reyes", contact: "09281234567", email: "jose@email.com", date: "2026-03-14", guests: 35, package: "Day Tour", rooms: [1], overtime: 2, total: 11500, downpayment: 5750, status: "Paid", paymentProof: true, notes: "" },
  { id: "SW-10003", name: "Ana Cruz", contact: "09391234567", email: "ana@email.com", date: "2026-03-20", guests: 20, package: "Day Tour", rooms: [], overtime: 0, total: 6000, downpayment: 3000, status: "Paid", paymentProof: false, notes: "" },
